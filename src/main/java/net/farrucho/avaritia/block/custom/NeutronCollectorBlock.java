...
public class NeutronCollectorBlock extends BlockWithEntity {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.NEUTRON_COLLECTOR, (world1, pos, state1, be) -> NeutronCollectorBlockEntity.tick(world1, pos, state1, be));//pode ser replaced a lambda reference para ::new
    }
